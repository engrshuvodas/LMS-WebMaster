							...
							<div class="col-md-9 content mt-4 pl-5">
								...
								<div class="card mr-5" style="width: 80rem;">
									<div class="card-body">
											...
											<input type="text" id="Department" class="form-control"><br>
											<label for="Designation" class="col-form-label"></label>Designation<br>
											<input type="text" id="Designation" class="form-control"><br>
											<label for="Password" class="col-form-label"></label>Password<br>
											<input type="password" id="Password" class="form-control">
											<button class="btn btn-outline-primary pl-4 pr-4 pt-2 pb-2 mt-3">Save</button>
									</div>
								</div>
								</div>
								</div>
